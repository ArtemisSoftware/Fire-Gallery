...
data class Picture(
    ...
    companion object{
        ...
        val picturesMockList = listOf(
            ...
            Picture(id = "2", isFavorite = true, title ="Image 1", author ="First author", imageUrl = "https://unebrasil.org/wp-content/uploads/2020/02/Artemis.jpg", chipColorConfig = ChipColorConfig.mockChipColorConfig),
